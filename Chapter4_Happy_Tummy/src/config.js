...
const restarauntList = [
  {
    ...
    data: {
      ...
      uuid: "6247e9c7-ee6c-4c50-b21a-f19f49ccb3af",
      city: "8",
      area: "Adyar",
      ...
      slugs: {
        restaurant:
          "kwality-walls-frozen-dessert-and-ice-cream-shop-adyar-adyar-5",
        city: "chennai",
      },
      cityState: "8",
      address:
        'ELAKKIYA: NO.43/59, 2ND STREET, VARADHAPURAM, KOTTUR, KOTTURPURAM, CHENNAI, Chennai Corporation Ward - 172, Tamil Nadu -600085 (HUL- I41B290P2426)"',
      ...
      aggregatedDiscountInfo: {
        ...
        descriptionList: [
          {
            meta: "30% off up to ₹75 on select items | Use code SWIGGYIT",
            discountType: "Percentage",
            operationType: "RESTAURANT",
          },
        ],
      ...
      thirdPartyVendor: "",
      adTrackingID: "cid=5669304~p=1~eid=00000185-8dfe-e755-13dd-1d3000bb011d",
      badges: {
        imageBased: [],
        textBased: [],
        textExtendedBadges: [],
  ...
  },
  {
    ...
    data: {
      ...
      uuid: "790b5031-d8df-42fb-94f2-803cb3667da3",
      city: "8",
      area: "Ayanavaram",
      ...
      slugs: {
        restaurant: "sri-balaji-fast-food-villivakkam-villivakkam",
        city: "chennai",
      },
      cityState: "8",
      address:
        "P.GOPINATH, No.23/38, P.E. KOVIL STREET, AYANAVARAM, Chennai,600023",
  ...
  },
  {
    ...
    data: {
      ...
      cityState: "8",
      address:
        "237/A, Kilpauk Garden Road, Chennai, Chennai, Tamil Nadu, Pin;- 600 010.",
      locality: "Kilpauk",
      parentId: 4961,
      unserviceable: false,
      veg: false,
      ...
      thirdPartyAddress: false,
      thirdPartyVendor: "",
      adTrackingID: "cid=5698576~p=4~eid=00000185-8dfe-e755-13dd-1d3100bb0477",
      badges: {
        imageBased: [],
        textBased: [],
        textExtendedBadges: [],
